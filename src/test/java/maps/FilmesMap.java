...
public class FilmesMap {
    ...
    public static void initFilme(){
        filme = new HashMap<>();
        filme.put("nome", "Vida de inseto");
        filme.put("descricao", "Arthur em seu mundo na vida de inseto e uma formiga bem atrapalhada porem bem inteligente");
        filme.put("duracao", 1.30);
